...
- i18next for multilanguage support
...
- Documentation and stories are stored as `/{component|api}/{component|api}.stories.tsx`
- Unit tests (jest & react-testing-library) are stored as `/{component|api}/{component|api}.test.tsx`
- E2E tests (cypress) are stored as `/{section|api}/{section|api}.spec.tsx`
...
<div class="link-list">
  ...
  <a class="link-item" href="" target="_blank">
    ...
    <span>
      <strong>Adding text localisations with i18next</strong>
      ...
    </span>
  </a>
